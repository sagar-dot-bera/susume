...
CREATE INDEX idx_interactions_tenant_user ON interactions (tenant_id, external_user_id);

CREATE INDEX idx_interactions_tenant_item ON interactions (tenant_id, external_item_id);
